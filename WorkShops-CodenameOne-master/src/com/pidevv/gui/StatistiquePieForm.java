...
public class StatistiquePieForm  extends BaseForm {
        ArrayList<Livraison>list = ServiceamaniLiv.getInstance().Affichageamani();
        ArrayList<Livraison>listt = ServiceamaniLiv.getInstance().encours();
       private boolean drawOnMutableImage;
   private double nbr_feedback=list.size(), nbr_livraison=listt.size();
   ServiceamaniLiv s= new ServiceamaniLiv();
    Form current;
BaseForm form;
        ...
        addTab(swipe, res.getImage("dog.jpg"), spacer1, "Bienvenue");
  ...
  ;       
       ...
       image.addActionListener(e -> {
           try{
           new AjoutLivraisonForm(Resources.getGlobalResources()).show();
           }catch(Exception exx) {
    ...
    //stats
    //nhadhro size ta3 labels zinaaaa
    ...
    public void createPieChartForm(){
        double total= nbr_feedback+ nbr_livraison;
        double prentfeed=(nbr_feedback*100)/total;
        double prentliv=(nbr_livraison*100)/total;
        ...
        PieChart chart= new PieChart(buildDataset("title", prentfeed,prentliv), renderer);
    ...
    private CategorySeries buildDataset(String title, double prentfeed, double prentliv) {
        CategorySeries series= new CategorySeries(title);
        series.add("livraison", prentliv);
        series.add("feedback", prentfeed);
        return series;
    }
}
